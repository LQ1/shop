...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
//        self.backgroundColor =[UIColor blueColor] ;//ZYPhotoBrowserBackgrounColor;
...
//    _contentView.backgroundColor = ZYPhotoBrowserBackgrounColor;
    _contentView.backgroundColor=[UIColor colorWithWhite:0.f alpha:1.];
...
//    UIViewController * collectionView = (UIViewController *)self.sourceImagesContainerView;
...
////    }
//
//    CGRect targetTemp = [self.sourceImagesContainerView convertRect:collectionView.view.frame toView:self];
    ...
    CGFloat tempImageViewH = (tempImageSizeH * ZYAPPWidth)/(tempImageSizeW==0?CGFLOAT_MAX:tempImageSizeW);
...
//        tempImageView.frame = CGRectMake(0, 0, 0, 0);
    } completion:^(BOOL finished) {
