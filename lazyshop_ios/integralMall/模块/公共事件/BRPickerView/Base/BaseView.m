...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        [_leftBtn setTitleColor:RGB_HEX(0xE4393C, 1.0) forState:UIControlStateNormal];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.backgroundColor = RGB_HEX(0xE4393C, 1.0);
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = RGB_HEX(0xE4393C, 1.0);
