...
@interface CouponMessageView()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic,strong)UITableView *mainTable;
@property (nonatomic,strong)CouponMessageViewModel *viewModel;

@end

@implementation CouponMessageView
...
#pragma mark -reload
- (void)reloadDataWithViewModel:(CouponMessageViewModel *)viewModel
{
