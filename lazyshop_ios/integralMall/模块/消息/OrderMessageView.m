...
@interface OrderMessageView()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic,strong)UITableView *mainTable;
@property (nonatomic,strong)OrderMessageViewModel *viewModel;
...
#pragma mark -reload
- (void)reloadDataWithViewModel:(OrderMessageViewModel *)viewModel
{
