...
@interface DLSimplePing : NSObject
...
@property (nonatomic, weak, readwrite, nullable) id<DLSimplePingDelegate> delegate;
...
@protocol DLSimplePingDelegate <NSObject>
